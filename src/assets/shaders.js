...
//     vec3(0.5, 0.6, 0.2), vec3(1.0, 1.0, 1.0), vec3(1.0, 1.0, 1.0), vec3(0.5, 0.2, 0.6),
//     vec3(0.4, 1.0, 0.2), vec3(1.0, 1.0, 1.0), vec3(1.0, 1.0, 1.0), vec3(0.4, 0.2, 1.0),
...
//     vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0), vec3(1.0, 1.0, 1.0), vec3(0.0, 0.0, 0.0),
//     vec3(0.0, 1.0, 0.0), vec3(1.0, 1.0, 1.0), vec3(1.0, 1.0, 1.0), vec3(0.0, 0.0, 1.0),
//     vec3(0.0, 1.0, 0.0), vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 1.0), vec3(0.0, 0.0, 1.0)
// );
const vec3[16] weights = vec3[16](
    vec3(0.5, 0.2, 0.2), vec3(1.0, 0.2, 0.2), vec3(1.0, 0.2, 0.2), vec3(0.5, 0.2, 0.2),
...
void main() {
    ...
    for (int i = 0; i < 6; i++) {
        ...
        // finalColour += neighbour_colour.rgb * colourWeights * 0.5;
    }

    // fragColor = vec4(subPixelColour, 1.0);
